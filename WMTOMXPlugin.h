...
#ifndef WMT_OMX_PLUGIN_H_

#define WMT_OMX_PLUGIN_H_

#include <media/stagefright/OMXPluginBase.h>

namespace android {

struct WMTOMXPlugin : public OMXPluginBase {
    WMTOMXPlugin();
    virtual ~WMTOMXPlugin();
...
private:
    ...
    WMTOMXPlugin(const WMTOMXPlugin &);
    WMTOMXPlugin &operator=(const WMTOMXPlugin &);
};

}  // namespace android

#endif  // WMT_OMX_PLUGIN_H_
